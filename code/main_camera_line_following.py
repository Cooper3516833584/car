...
class CameraLineApplication:
    ...
    def _front_camera_vision_config() -> LineVisionConfig:
        ...
        return LineVisionConfig(
            ...
            maximum_center_jump_cm=13.0,
            morphology_close_size=9,
            polynomial_smoothing_alpha=0.12,
    ...
    def _control_config_for_speed(speed_cm_s: float) -> LineControlConfig:
        ...
        return replace(
            ...
            minimum_lookahead_cm=45.0,
            maximum_lookahead_cm=65.0,
            lookahead_speed_gain_s=0.04,
            lateral_gain=0.22,
            heading_gain=0.20,
            curvature_feedforward_gain=0.85,
            maximum_abs_steering_rad=0.22,
            maximum_steering_rate_rad_s=0.25,
            steering_low_pass_time_constant_s=0.45,
            steering_deadband_rad=0.015,
            recovery_good_frames=5,
            short_loss_frames=1,
    ...
    def _on_follower_state(self, state: LineFollowerState) -> None:
        ...
        if (
            ...
            LOG.debug(
                ...
                "heading_rad=%.3f curvature_cm_inv=%.5f round=%s transverse=%s",
                state.status.value,
